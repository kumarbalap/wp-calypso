	...
	render() {
		...
		if ( productsError ) {
			return <EmptyContent
				...
				line={ translate( 'Please try again or {{contactSupportLink}}contact support{{/contactSupportLink}}.',
					{ components: {
						contactSupportLink: <a href="/help/contact" target="_blank" rel="noopener noreferrer" />
					} }
			) } />;
		}
